...
rooms = {"room1": {"name":"name", "description":"description", "completed":"completed"},
        "room2":{"name":"name", "description":"description", "completed":"completed"},
        "room3":{"name":"name", "description":"description", "completed":"completed"}}
